    ...
    >
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-extrabold bg-gradient-to-r from-cyan-400 via-blue-500 to-indigo-500 bg-clip-text text-transparent">
            Creative Works
          </h2>
          <p className="text-gray-400 mt-4 max-w-2xl mx-auto">
            A showcase of selected projects that blend **security, innovation, and
            performance** — crafted to deliver premium user experiences.
          </p>
        </div>
